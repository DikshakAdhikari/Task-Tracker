...
export const Todos= ()=> {
    ...
    return(
        ...
        <div className="flex flex-col gap-10 ml-5 mt-10">
            <div className='font-bold text-[30px] text-blue-950'>Add Todo</div>
...
const TodoList = ()=> {
    ...
    return (
        <>
        <div className='font-bold text-[30px] text-blue-950 ml-5'>Todo List</div>
        ...
        <div className='flex flex-col-reverse'>
            ...
            todos.map((todo:Todo)=> (
                <div className='m-5 shadow-lg p-5 flex flex-col gap-3' key={todo.id}>
                    <div className='font-bold text-[25px] text-red-900'>{todo.title}</div>
                    <div className=' font-bold text-blue-950'>{todo.description}</div>
